...
<header>
	...
	<div class="menu">
		<ul>
			<li class="logo"><a href="https://delivery" target="_blank"><img height="44" title="CodeIgniter Logo"
			...
			<li class="menu-item hidden"><a href="#" target="_blank">Docs</a></li>
	...
	<div class="heroe">
		...
		<h1>Welcome to Delivery API </h1>

		<h2>The small API with powerful delivery features</h2>
...
<footer>
	...
	<div class="copyrights">
		...
		<p>&copy; <?= date('Y') ?> made by deliveryTeam</p>
